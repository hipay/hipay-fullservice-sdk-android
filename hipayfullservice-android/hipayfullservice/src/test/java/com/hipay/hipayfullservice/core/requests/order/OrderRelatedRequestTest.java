...
public class OrderRelatedRequestTest {
    ...
    public void testGetters() throws Exception {
        ...
        orderRelatedRequest.getAcceptURL();
        orderRelatedRequest.getDeclineURL();
        orderRelatedRequest.getPendingURL();
        orderRelatedRequest.getExceptionURL();
        orderRelatedRequest.getCancelURL();
    ...
    public void testSetters() throws Exception {
        ...
        orderRelatedRequest.setAcceptURL(null);
        orderRelatedRequest.setDeclineURL(null);
        orderRelatedRequest.setPendingURL(null);
        orderRelatedRequest.setExceptionURL(null);
        orderRelatedRequest.setCancelURL(null);
