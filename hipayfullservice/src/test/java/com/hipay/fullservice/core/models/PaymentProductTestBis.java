...
public class PaymentProductTestBis {

    @Mock
    PaymentProduct paymentProduct;

    @Test
    public void paymentProductTestThing() {
        ...
        */
        ...
        //PaymentProduct.SecurityCodeType result = PaymentProduct.securityCodeTypeForPaymentProductCode(PaymentProduct.PaymentProductCodeBCMC);
        //assertEquals(result, PaymentProduct.SecurityCodeType.SecurityCodeTypeNone);
