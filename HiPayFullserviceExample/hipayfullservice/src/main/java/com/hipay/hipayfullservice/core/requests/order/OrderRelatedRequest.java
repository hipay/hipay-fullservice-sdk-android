...
public class OrderRelatedRequest extends AbstractRequest {
    ...
    private void initURLParameters() throws MalformedURLException, URISyntaxException {
        ...
        Utils.concatenate(appURL, stringBuilder.toString());

        this.setAcceptURL(Utils.concatenate(appURL, OrderRelatedRequestRedirectPathAccept));
        this.setDeclineURL(Utils.concatenate(appURL, OrderRelatedRequestRedirectPathDecline));
        this.setPendingURL(Utils.concatenate(appURL, OrderRelatedRequestRedirectPathPending));
        this.setCancelURL(Utils.concatenate(appURL, OrderRelatedRequestRedirectPathCancel));
        this.setExceptionURL(Utils.concatenate(appURL, OrderRelatedRequestRedirectPathException));
